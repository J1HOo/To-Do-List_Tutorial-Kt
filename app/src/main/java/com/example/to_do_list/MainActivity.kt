...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var todoList: MutableLiveData<MutableList<TodoDate>>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //뷰모델 받아오기
        viewModel = ViewModelProvider(this, ViewModelProvider(this.application))
        ...
        todayAdapter = MyAdapter(this, mutableListOf<TodoDate>(), viewModel, ::goToDetail, ::setList)
        ...
        add_todo.setOnClickListener {
            if (input_todo.text.toString() != "") {
                val todo = TodoDate(input_todo.text.toString())
    ...
    fun goToDetail(todo: TodoDate, position: Int) {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == RC_GO_TO_DETAIL && resultCode == Activity.RESULT_OK) {
            ...
            val todo = bundle?.getSerializable("todo") as TodoDate
